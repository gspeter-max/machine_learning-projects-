...
xgb = XGBClassifier(learning_rate=0.01, n_estimators=200, max_depth=5, use_label_encoder=False, eval_metric='auc', class_weight=class_weight_)
...
def objective(trial):
    ...
    score = roc_auc_score(y_val_, y_predict_proba)
...
upgrade_model.fit(x_train, y_train)
